...
class DPTHead(nn.Module):
    ...
    def forward(self, encoder_features, patch_h, patch_w, 
        ...
        for i, x in enumerate(encoder_features):
            # clstoken has been already removed from encoder forward path
    ...
    def forward_with_mamba(self, encoder_features, patch_h, patch_w, temporal_layer, mamba_fn, return_multiple=False, **kwargs):
